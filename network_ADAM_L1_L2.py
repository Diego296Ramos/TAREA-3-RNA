...
class Network(object):
    def __init__(self, sizes):
        ...
        self.model.add(Dense(units=sizes[1], activation='sigmoid', input_dim=sizes[0], kernel_regularizer=l1(0.01), activity_regularizer=l2(0.01) ))
        ## Se agrega la capa densa, con sizes[1] neuronas y dimensión sizes[0], f sigmoide, regularizadores l1 y l2
        for size in sizes[2:-1]:
            self.model.add(Dense(units=size, activation='sigmoid', kernel_regularizer=l1(0.01), activity_regularizer=l2(0.01)))

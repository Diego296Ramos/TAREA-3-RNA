...
class Network(object):
    def __init__(self, sizes):
        ...
        self.model.add(Dense(units=sizes[1], activation='sigmoid', input_dim=sizes[0], kernel_regularizer = l1(0.01)))
        ## Se agrega la capa densa, con sizes[1] neuronas y dimensión sizes[0], f sigmoide y regularizador l1
        for size in sizes[2:-1]:
            self.model.add(Dense(units=size, activation='sigmoid', kernel_regularizer = l1(0.01)))
        ...
        ## Se copila el modelo, con los optimizador RMSprop, función de perdida mean_squared_error y metrica accuracy
